...
exports.StashaCompletionProvider = void 0;
...
class StashaCompletionProvider {
    provideCompletionItems(doc, pos) {
        ...
        return (response.completions ?? []).map(item => {
            const c = new vscode.CompletionItem(item.label, KIND_MAP[item.kind] ?? vscode.CompletionItemKind.Variable);
            if (item.detail)
...
exports.StashaCompletionProvider = StashaCompletionProvider;
