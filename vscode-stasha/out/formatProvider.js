...
exports.StashaFormatProvider = void 0;
const vscode = __importStar(require("vscode"));
const child_process_1 = require("child_process");
const compilerPath_1 = require("./compilerPath");
class StashaFormatProvider {
    provideDocumentFormattingEdits(doc) {
        const cfg = vscode.workspace.getConfiguration('stasha');
        if (!cfg.get('enableFormat', true))
            return undefined;
        const bin = (0, compilerPath_1.getCompilerPath)();
        const result = (0, child_process_1.spawnSync)(bin, ['format', '--stdin', '--path', doc.uri.fsPath], {
            input: doc.getText(),
            encoding: 'utf8',
            timeout: 10000,
        });
...
exports.StashaFormatProvider = StashaFormatProvider;
